...
while($daycount <= $numofdays) {
 ...
 if($daynextcount==1) { echo "<tr>"; }
 echo "<td style=\"width: 14%; height: 100px; vertical-align: top;\"><a href=\"xhtml.php?games&amp;date=".urlencode(date("Y", $curtimestamp).date("m", $curtimestamp).$daycheck)."\">".$daycount."</a><br /><br /><div style=\"text-align: center;\">".$numofgames." Games</div></td>"; 
