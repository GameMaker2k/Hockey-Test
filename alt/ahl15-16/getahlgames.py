...
geturls_text = geturls_opener.open(
    "http://theahl.com/stats/schedule.php?date=" +
    getforyear +
    "-" +
    getformonth +
    "-" +
...
while (cur_todays_games < num_todays_games):
    ...
    urllib2.install_opener(geturls_opener)
    geturls_text = geturls_opener.open(
        "http://theahl.com/stats/game-summary.php?game_id=" +
    ...
    if (numpers == 3):
        print(
            ...
            team_text[2] +
            "\", \"" +
            curgame_score_text[1][0] +
            ":" +
            curgame_score_text[0][0] +
            "," +
            curgame_score_text[1][1] +
            ":" +
            curgame_score_text[0][1] +
            "," +
            curgame_score_text[1][2] +
            ":" +
            curgame_score_text[0][2] +
            "\", \"" +
            curgame_score_text[3][0] +
            ":" +
            curgame_score_text[2][0] +
            "," +
            curgame_score_text[3][1] +
            ":" +
            curgame_score_text[2][1] +
            "," +
            curgame_score_text[3][2] +
            ":" +
            curgame_score_text[2][2] +
            "\", 0, False);")
    if (numpers == 4):
        print(
            "MakeHockeyGame((sqlcur, sqlcon), " +
            ...
            curgame_score_text[0][2] +
            "," +
            curgame_score_text[1][3] +
            ":" +
            curgame_score_text[0][3] +
            "\", \"" +
            curgame_score_text[3][0] +
            ":" +
            curgame_score_text[2][0] +
            ...
            curgame_score_text[2][2] +
            "," +
            curgame_score_text[3][3] +
            ":" +
            curgame_score_text[2][3] +
            "\", 0, False);")
    if (numpers == 5):
        print(
            "MakeHockeyGame((sqlcur, sqlcon), " +
            ...
            curgame_score_text[0][3] +
            "," +
            curgame_score_text[1][4] +
            ":" +
            curgame_score_text[0][4] +
            "\", \"" +
            curgame_score_text[3][0] +
            ":" +
            curgame_score_text[2][0] +
            ...
            curgame_score_text[2][3] +
            "," +
            curgame_score_text[3][4] +
            ":" +
            curgame_score_text[2][4] +
            "\", 0, False);")
