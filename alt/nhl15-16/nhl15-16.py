...
MakeHockeyTeams((sqlcur,
                ...
                "Buffalo",
                "ECHL:Elmira Jackals,AHL:Rochester Americans ")
MakeHockeyTeams((sqlcur,
                 sqlcon),
                "Detroit",
                "MI",
                ...
                "Joe Louis Arena",
                "Detroit",
                "ECHL:Toledo Walleye,AHL:Grand Rapids Griffins ")
MakeHockeyTeams((sqlcur,
                 sqlcon),
                "Sunrise",
                "FL",
                ...
                "BB&T Center",
                "Florida",
                "ECHL:None,AHL:Portland Pirates")
MakeHockeyTeams((sqlcur,
                 sqlcon),
                "Montreal",
                "QC",
                ...
                "Bell Centre",
                "Montreal",
                "ECHL:Brampton Beast,AHL:St. John's Icecaps")
MakeHockeyTeams((sqlcur,
                 sqlcon),
                "Ottawa",
                "ON",
                ...
                "Ottawa",
                "ECHL:Evansville IceMen,AHL:Binghamton Senators")
MakeHockeyTeams((sqlcur,
                 sqlcon),
                "Tampa Bay",
                "FL",
...
MakeHockeyTeams((sqlcur,
                ...
                "Air Canada Centre",
                "Toronto",
                "ECHL:Orlando Solar Bears,AHL:Toronto Marlies")
...
MakeHockeyTeams((sqlcur,
                ...
                "PNC Arena",
                "Carolina",
                "ECHL:Florida Everblades,AHL:Charlotte Checkers")
MakeHockeyTeams((sqlcur,
                 sqlcon),
                "Columbus",
                "OH",
                ...
                "Nationwide Arena",
                "Columbus",
                "ECHL:Kalamazoo Wings,AHL:Lake Erie Monsters")
MakeHockeyTeams((sqlcur,
                 sqlcon),
                "New Jersey",
                "NJ",
...
MakeHockeyTeams((sqlcur,
                ...
                "Barclays Center",
                "New York",
                "ECHL:Missouri Mavericks,AHL:Bridgeport Sound Tigers")
MakeHockeyTeams((sqlcur,
                 sqlcon),
                "New York City",
                "NY",
                ...
                "New York",
                "ECHL:Greenville Swamp Rabbits,AHL:Hartford Wolf Pack")
MakeHockeyTeams((sqlcur,
                 sqlcon),
                "Philadelphia",
                "PA",
                ...
                "Wells Fargo Center",
                "Philadelphia",
                "ECHL:Reading Royals,AHL:Lehigh Valley Phantoms")
MakeHockeyTeams((sqlcur,
                 sqlcon),
                "Pittsburgh",
                "PA",
                ...
                "Pittsburgh",
                "ECHL:Wheeling Nailers,AHL:Wilkes-Barre/Scranton Penguins")
MakeHockeyTeams((sqlcur,
                 sqlcon),
                "Washington",
                "D.C.",
                ...
                "Verizon Center",
                "Washington",
                "ECHL:South Carolina Stingrays,AHL:Hershey Bears")
...
MakeHockeyTeams((sqlcur,
                ...
                "United Center",
                "Chicago",
                "ECHL:Indy Fuel,AHL:Rockford IceHogs")
MakeHockeyTeams((sqlcur,
                 sqlcon),
                "Denver",
                "CO",
                ...
                "Pepsi Center",
                "Colorado",
                "ECHL:Fort Wayne Komets,AHL:San Antonio Rampage")
MakeHockeyTeams((sqlcur,
                 sqlcon),
                "Dallas",
                "TX",
                ...
                "Dallas",
                "ECHL:Idaho Steelheads,AHL:Texas Stars")
MakeHockeyTeams((sqlcur,
                 sqlcon),
                "St. Paul",
                "MN",
                ...
                "Xcel Energy Center",
                "Minnesota",
                "ECHL:Quad City Mallards,AHL:Iowa Wild")
MakeHockeyTeams((sqlcur,
                 sqlcon),
                "Nashville",
                "TN",
                ...
                "Bridgestone Arena",
                "Nashville",
                "ECHL:Cincinnati Cyclones,AHL:Milwaukee Admirals")
MakeHockeyTeams((sqlcur,
                 sqlcon),
                "St. Louis",
                "MO",
...
MakeHockeyTeams((sqlcur,
                ...
                "MTS Centre",
                "Winnipeg",
                "ECHL:Tulsa Oilers,AHL:Manitoba Moose")
...
MakeHockeyTeams((sqlcur,
                ...
                "Honda Center",
                "Anaheim",
                "ECHL:Utah Grizzlies,AHL:San Diego Gulls")
MakeHockeyTeams((sqlcur,
                 sqlcon),
                "Glendale",
                "AZ",
                ...
                "Gila River Arena",
                "Arizona",
                "ECHL:Rapid City Rush,AHL:Springfield Falcons")
MakeHockeyTeams((sqlcur,
                 sqlcon),
                "Calgary",
                "AB",
                ...
                "Calgary",
                "ECHL:Adirondack Thunder,AHL:Stockton Heat")
MakeHockeyTeams((sqlcur,
                 sqlcon),
                "Edmonton",
                "AB",
                ...
                "Rexall Place",
                "Edmonton",
                "ECHL:Norfolk Admirals,AHL:Bakersfield Condors")
MakeHockeyTeams((sqlcur,
                 sqlcon),
                "Los Angeles",
                "CA",
...
MakeHockeyTeams((sqlcur,
                ...
                "SAP Center",
                "San Jose",
                "ECHL:Allen Americans,AHL:San Jose Barracuda")
MakeHockeyTeams((sqlcur,
                 sqlcon),
                "Vancouver",
                "BC",
